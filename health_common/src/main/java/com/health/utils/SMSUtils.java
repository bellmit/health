...
public class SMSUtils {
	public static final String VALIDATE_CODE = "SMS_203671692";//发送短信验证码模板编码  模版CODE
	public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
	private static final String SIGN_NAEM = "MyHealth";// 短信的签名
	private static final String PARAMETER_NAME="code";
	private static final String ACCESS_KEY="LTAI4GH2TsKHMNRu9trzJcY4"; //你的AccessKey ID
	private static final String SECRET_KEY="9cpqHW2HwWJcrPZFEMwQBWReLfaYHp"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
		SMSUtils.sendShortMessage(VALIDATE_CODE,"18872425645","666666");
	}
