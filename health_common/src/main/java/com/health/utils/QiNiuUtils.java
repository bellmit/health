...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "MjOtYrljCqtyeyGQZdKRpHJv6RAdSgdTZgujE4vG";
    private static final String SECRETKEY = "BSbAPLX7Xzb_m0aXeUKh0-f8jTfX4sVncfljmD3D";
    private static final String BUCKET = "hw001";
    public static final String DOMAIN= "http://qh1peook6.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\timg.jpg","dd2.jpg");
